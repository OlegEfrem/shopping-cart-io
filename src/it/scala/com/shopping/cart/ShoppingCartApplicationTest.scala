...
class ShoppingCartApplicationTest extends CatsEffectSuite {
  ...
  private implicit def doubleToPositiveSmallDecimal(double: Double): PositiveSmallDecimal = PositiveSmallDecimal(double)
